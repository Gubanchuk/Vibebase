...
export default function VibecodingPlacementPage() {
  return (
    <>
      ...
      <section className="px-4 md:px-6 py-8 max-w-3xl">
        <div
        ...
        <h1 className="text-[24px] md:text-[28px] font-bold tracking-tight leading-tight mb-1">
          Определим{" "}
          <span
            className="serif-italic text-[26px] md:text-[30px]"
